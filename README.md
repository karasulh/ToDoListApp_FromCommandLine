This repo is a basic To Do App by using Command Line Interface(CLI). By running our application with necessary arguments which are action and task, our task states are updated in todo.db file. 
